superpc.predict.red.cv <- function(fitred, 
                                   fitcv, 
                                   data, 
                                   threshold,  
                                   sign.wt="both") {
    ...
    return(list(shrinkages=shrinkages, 
                ...
                lrtest.reduced.lower=lrtest.reduced.lower, 
                lrtest.reduced.upper=lrtest.reduced.upper,
                n.components=n.components,
                num.features=fitred$num.features,
                sign.wt=sign.wt,
                import.cv=import.cv,
                type=type,
                call=this.call))
